...
//		NetworkInfo netInfo = (NetworkInfo) extras.get(WifiManager.WIFI_STATE_CHANGED_ACTION);
//		
...
//		    int level = WifiManager.calculateSignalLevel(connectionInfo.getRssi(), numberOfLevels);
//		    
//		    AsyncRequestRoomList async = new AsyncRequestRoomList();
//			async.execute(connectionInfo.getSSID(), connectionInfo.getBSSID(), level);
//		}
...
//	http://stackoverflow.com/questions/12460445/how-to-get-bssid-of-all-wifi-access-points
	public ScanResult loadWifiAvailableList() {
        ...
        WifiManager wifiManager = (WifiManager) 
                                    fragment.getActivity().getSystemService(Context.WIFI_SERVICE);
